...
import com.libertad.demo.common.utils.DateUtils;
import com.libertad.demo.common.dense.SecurityKit;
import com.libertad.demo.common.dense.SecurityKit.RSA;
...
public class UserTokenUtils {
	...
	public static String tokenEncrypt(String pubKey,JSONObject data){
        String encryptData = RSA.encrypt(data.toJSONString(), pubKey, RSA.PUBLIC_KEY, "UTF-8");
        return encryptData;
	...
	public static String tokenDecrypt(String encryptData,String priKey){
		String decryptData = RSA.decrypt( encryptData, priKey, RSA.PRIVATE_KEY, "UTF-8" );
        return decryptData;
	}
