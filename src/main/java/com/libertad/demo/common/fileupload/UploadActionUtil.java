package com.libertad.demo.common.fileupload;
...
import com.libertad.demo.common.core.configurer.MultipartConfigurer;
         ...
         while (iterator.hasNext()) {
            ...
            if (file != null) {
               ...
               if (myFileName.trim() != "") {
                  ...
                  // 创建文件夹
                  String folderPath = new MultipartConfigurer().uploadPath + File.separator + folderName();
                  ...
                  list.add(new MultipartConfigurer().uploadPath + "//" + myFileName);
               }
            }
         }
      }
